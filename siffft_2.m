...
I=imread('veinseye.tif'); 


% to read the image
I_read=imresize(I,[512 512]);
I_enlarge=imresize(I_read,[526 526]);       % image resize
...
tic;
 ...
 diff_11=octave1(1:255,1:250)-octave1(1:255,255:500);      % differnce of gaussian for octave1
 
 diff_12=octave1(1:215,250:500)-octave1(1:215,250:1536);
 
 diff_13=octave1(1:125,150:250)-octave1(1:250,520:500);
